...
<!--            <div class="memberFormDiv">-->
<!--                <h1>회원가입</h1>-->
<!--                <form class="memberForm" name="firstForm" action="/member/exec.php" method="post">-->
...
<!---->
<!--                    <label for="email">Email <span style="color: red">*</span></label> <button onclick="emailCheck(e)">인증하기</button><br>-->
<!--                    <input type="email" id="email" name="email" placeholder="이메일을 입력하세요 예시: abc@naver.com" required>-->
<!--                    <p id="email_warning" style="display: none; margin-top: 0px"></p>-->
<!---->
<!--                    <label for="phone">Phone <span style="color: red">*</span></label><br>-->
<!--                    <input type="text" id="phone" name="phone" placeholder="휴대폰 번호를 입력하세요 -은 생략해도 됩니다"><br>-->
<!--                    <p id="phone_warning" style="display: none; margin-top: 0px"></p>-->
<!---->
<!--                    <label for="address">Address</label><br>-->
<!--                    <input type="text" id="address" name="address" placeholder="주소를 입력하세요"><br><br>-->
<!---->
    ...
    <div class="holeMemberFormDiv">
        <div class="memberFormDiv">
            ...
            >
                ...
                <label for="email">이메일 <span style="color: red">*</span></label><button onclick="emailCheck(event)">메일인증</button>
                <input
                        type="email"
                        id="email"
                        name="email"
